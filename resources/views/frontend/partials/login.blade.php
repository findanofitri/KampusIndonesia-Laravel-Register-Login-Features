            ...
            <div class="modal-body modal-login">
                ...
                <form class="socmed-login" action="" method="">
                    ...
                    <div class="form-group row">
                        <div class="col-md-6">
                            <a href="/auth/google" class="btn socmed-btn google-btn" id="btn-google"><img src="assets/img/frontend/img-componen/google-logo.png" style="width:18px; height:18px;">   Masuk dengan Google</a>
                        </div>
                        <div class="col-md-6 .ml-auto">
                            <a href="/auth/facebook" class="btn socmed-btn facebook-btn" id="btn-facebook"><img src="assets/img/frontend/img-componen/facebook_logos.png" style="width:28.5px; height:28.5px;">   Masuk dengan Facebook</a>
                        </div>
                    </div>
                    <div class="separator">
                ...
                <form class="login-content" id="login-form">
                     <!-- untuk csrf-token saya pindahkan di app.blade.php -->
                    <input type="hidden" id="_token" name="_token" > 
                    <!-- input email user -->
                    <div class="form-group row">
                        <input type="email" class="form-control active" name="email" id="email" placeholder="Alamat Email" required>
                    </div>
                    <!-- input password user -->
                    <div class="form-group row">
                        <input type="password" class="form-control active" name="password" id="password" placeholder="Password" required>
                        <div class="group">
                    ...
                    <center> <input type="submit" id="btn-login" class="btn btn-login btn-primary mt-3" name="login login-submit" value="MASUK"></center>
